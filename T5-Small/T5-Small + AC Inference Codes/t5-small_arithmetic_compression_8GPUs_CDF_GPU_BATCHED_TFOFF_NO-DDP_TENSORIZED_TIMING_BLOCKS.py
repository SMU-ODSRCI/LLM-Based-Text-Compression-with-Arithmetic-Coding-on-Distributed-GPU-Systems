...
# Here, CausalT5 refers to the fine-tuned T5-Small checkpoints
...
def evaluate_ac_t5(rank, world_size, local_rank, data_path = 'wiki.train.txt', context_window = 64, temperature = 1.0):
	...
	stride = 128 # This allows the second inner batch loop to advance forward exactly by the no. of batched streams fed to the GPU
